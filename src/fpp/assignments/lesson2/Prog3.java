...
public class Prog3 {
	public static void main(String[] args){
		...
		// Implement the code 
		 ...
		 String[] rowStrArr = records.split(":");
		 String[] prodIdArr = new String[rowStrArr.length];
		 for(int i=0; i< rowStrArr.length;i++) {
			 String[] colStr =  rowStrArr[i].split(",");
				prodIdArr[i] = colStr[0] ;
		 }
		 System.out.println("Product IDs:");
		 for(String prodStr: prodIdArr) {
